...
- `2026-04-13 scope guard / hub uplift / hardening 批次`
  - 从 [372-2026-04-13-observer-restore scope clarification 拆分记忆.md](./372-2026-04-13-observer-restore%20scope%20clarification%20拆分记忆.md) 一路看到 [405-2026-04-13-builder-callback-ui subfamily hub uplift 拆分记忆.md](./405-2026-04-13-builder-callback-ui%20subfamily%20hub%20uplift%20拆分记忆.md)。
- `更早批次`
  - 直接跳到下面的“全量档案”，按编号顺着翻。
