...
| persisted tool-results layout | `src/utils/toolResultStorage.ts:94-124` | persisted outputs 现在仍活在哪个 cleanup world |
| visible project/session sweep | `src/utils/cleanup.ts:155-257,300-428,575-598` | cleanup 怎样继续进入更广的 carrier families |
