...
| covered retention execution | `src/utils/cleanup.ts:23-30,33-40,93-131,155-190,300-303,305-348,350-428,575-596` | 哪些 visible carriers 当前已经纳入 cleanup horizon，以及结果如何只停留在 local vocabulary |
