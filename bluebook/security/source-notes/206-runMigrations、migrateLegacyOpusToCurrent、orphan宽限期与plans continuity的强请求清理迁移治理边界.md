...
| 主题 | 关键源码 | 这里回答的问题 |
| --- | --- | --- |
| startup migration chain | `src/main.tsx:325-345` | 为什么 repo 已把迁移治理当成显式 startup governance |
...
| cleanup migration gap | `src/utils/cleanup.ts:33-45,300-303,575-598`; `src/utils/diagLogs.ts:14-60` | 为什么 stronger-request cleanup 线当前还没有 old-world exit grammar |
