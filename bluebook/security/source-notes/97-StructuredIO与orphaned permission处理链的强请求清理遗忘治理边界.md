...
`print.ts:2766-2782,5241-5305` 很硬。
...
## 8. 为什么这层不等于 `96` 的 stronger finality gate
...
1. `96` 的典型形态是 `tool_result`、`files_persisted`、`idle`、`state_restored`
2. `97` 的典型形态是 `resolvedToolUseIds`、`handledOrphanedToolUseIds`、duplicate ignore、bounded eviction
