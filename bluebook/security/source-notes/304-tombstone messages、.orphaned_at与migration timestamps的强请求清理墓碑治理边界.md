...
1. 旧 startup wording 退役后留下什么 machine-consumable marker
2. 旧 cleanup path 结束后谁继续消费这类 marker
3. 旧 promise vocabulary 的 post-retirement residue 应怎样约束 future recovery / audit
4. 旧 receipt semantics 退场后该保留哪种 trace artifact 防止误复活
5. 哪些 marker 属于 delayed delete，哪些属于 history-only trace，哪些属于 resurrection gate prerequisite

这意味着 stronger-request cleanup 当前虽然已经开始显露 sunset-governance，
却还没有谁正式回答：

`旧世界结束后，哪些最小事实必须继续存在，才能约束未来解释。`

## 11. 苏格拉底式自反诘问：我是不是又把“旧世界已经正式结束”误认成了“旧世界结束后的解释义务也结束了”
