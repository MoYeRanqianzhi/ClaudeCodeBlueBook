...
| retry wording at tool layer | `src/services/tools/toolExecution.ts:583-596,1073-1100` | 为什么 prerequisite repair / permission recovery 仍要单独说 `retry this call` |
...
| preserved step-up intent | `src/components/mcp/MCPRemoteServerMenu.tsx:263-289`; `src/services/mcp/auth.ts:579-617,903-935,1884-1898` | 为什么保留更高 scope / discovery state 只说明 higher-authority target continuity，仍不等于 same-request continuation |
