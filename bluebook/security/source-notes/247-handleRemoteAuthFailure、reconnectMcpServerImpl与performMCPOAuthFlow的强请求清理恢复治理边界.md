...
`services/mcp/client.ts:337-360`
很值钱。
...
`services/mcp/client.ts:2288-2345`
...
`services/mcp/client.ts:2137-2194`
是这一层最强的恢复锚点。
...
`tools/McpAuthTool/McpAuthTool.ts:39-195`
把自己的定位写得非常清楚：
