...
## 9. 为什么这些正对照会反过来暴露 stronger-request cleanup 的当前缺口

和这些成熟 sunset grammar 对照，
...
`current-truth cutoff grammar`

更具体地说，
现在还没有哪一层正式决定：

1. 旧 startup wording 到何时仍只是 tolerated residue
2. 旧 cleanup law 到何时仍可以继续被 runtime 承认
3. 旧 covered-family covenant 到何时退出 visibility world
4. 旧 receipt / local-count truth 到何时只剩历史解释价值
5. 旧 stronger-request promise 何时必须被 hard-close

这意味着 stronger-request cleanup 当前虽然已经开始显露 migration-governance，
却还没有谁正式回答：

`什么时候起，这些旧事实不再配被当成 current truth。`

## 10. 苏格拉底式自反诘问：我是不是又把“旧世界已经被过渡处理”误认成了“旧世界已经正式结束”
