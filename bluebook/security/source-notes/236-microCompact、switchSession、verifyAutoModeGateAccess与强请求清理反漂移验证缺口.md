...
| stronger-request cleanup conformance cluster | `src/utils/sessionStorage.ts:953-969`; `src/utils/backgroundHousekeeping.ts:28-80`; `src/utils/cleanup.ts:33-44,300-303,575-598`; `src/utils/plans.ts:79-110,164-233`; `src/utils/diagLogs.ts:14-60` | 为什么 cleanup 线当前仍主要是在表达 conformance symptom，而不是 verifier grammar |
