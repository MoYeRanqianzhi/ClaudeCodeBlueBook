...
| step-up pending state | `src/services/mcp/auth.ts:1468-1470,1625-1690` | 为什么当前 token fresh 不等于当前 scope 足够 |
| step-up continuation | `src/services/mcp/auth.ts:579-618,909-940,1887-1900` | 为什么更强授权要保留自己的 state across revoke/re-auth |
...
`auth.ts:579-618,909-940,1887-1900`
很值钱。
