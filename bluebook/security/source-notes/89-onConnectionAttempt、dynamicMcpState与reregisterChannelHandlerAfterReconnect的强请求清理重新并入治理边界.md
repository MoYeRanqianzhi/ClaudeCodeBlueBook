...
| control-plane reintegration | `src/cli/print.ts:3148-3204,3255-3288,3391-3445` | 为什么 print mode 里 recovery 之后还要单独写回 state 与重绑 handlers |
| next-turn tool visibility | `src/cli/print.ts:1468-1490` | 为什么 recovered tools 只有写进 `dynamicMcpState` 才能真正回到下一轮工具池 |
| current status visibility | `src/cli/print.ts:1608-1630` | 为什么 recovered clients 只有写进 current state 才能回到 status plane |
| event / channel re-entry | `src/cli/print.ts:1248-1285,4786-4845` | 为什么 live interaction surface 的回归还需要单独 rebind |
