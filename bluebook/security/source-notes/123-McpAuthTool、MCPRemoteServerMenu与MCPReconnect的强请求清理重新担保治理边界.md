...
| 主题 | 关键源码 | 这里回答的问题 |
| --- | --- | --- |
| graded auth guidance | `src/tools/McpAuthTool/McpAuthTool.ts:57-60,182-196` | 为什么同一 auth story 的正向 assurance lexicon 仍要分强弱 |
| auth-complete branching | `src/components/mcp/MCPRemoteServerMenu.tsx:95-111,279-288` | 为什么 auth success 还不能自动升级成 stronger all-clear |
...
`MCPRemoteServerMenu.tsx:95-111,279-288`
很硬。
