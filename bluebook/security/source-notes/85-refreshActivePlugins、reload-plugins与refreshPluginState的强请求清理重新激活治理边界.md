...
| scenario-sensitive activation policy | `src/services/plugins/PluginInstallationManager.ts:135-180` | 为什么 new install 与 update 不共享同一 reactivation rule |
...
`PluginInstallationManager.ts:135-180`
把制度写得很清楚：
