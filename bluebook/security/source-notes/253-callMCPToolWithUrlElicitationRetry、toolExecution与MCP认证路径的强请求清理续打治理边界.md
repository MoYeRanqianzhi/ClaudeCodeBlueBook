...
| auth success restoration | `src/tools/McpAuthTool/McpAuthTool.ts:126-205` | 为什么 auth success 主要签 tools/resources become available，而不是 old blocked stronger cleanup request replay |
...
## 7. 为什么这层不等于 `252` 的 step-up 重授权剖面
