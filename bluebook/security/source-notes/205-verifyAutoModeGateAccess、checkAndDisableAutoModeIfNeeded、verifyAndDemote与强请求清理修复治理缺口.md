...
| plugin verify/demote split | `src/utils/plugins/dependencyResolver.ts:177-233`; `src/utils/plugins/pluginLoader.ts:3189-3195` | 为什么 repo 已显式拥有 verify + governance consequence + scope grammar |
