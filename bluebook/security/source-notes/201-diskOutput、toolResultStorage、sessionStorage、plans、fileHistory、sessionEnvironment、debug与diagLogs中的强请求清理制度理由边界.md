...
| operational debugging rationale | `src/utils/debug.ts:30-68,91-111,216-230`; `src/utils/cleanup.ts:391-428` | 为什么 debug logs 不是 generic retained artifact，而是 operational surface |
| host monitoring rationale | `src/utils/diagLogs.ts:11-20,27-53` | 为什么 diagnostics family 更接近 host-visible monitoring world |
