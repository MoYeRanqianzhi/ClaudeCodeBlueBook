...
| stable but still local truth | `src/utils/fileHistory.ts:951-957`; `src/utils/sessionEnvironment.ts:14-21,60-140`; `src/utils/debug.ts:30-68,91-111,229-249` | 为什么有些 family 暂时没失灵，也仍不等于已经 metadata 化 |
...
`fileHistory.ts:951-957`、`sessionEnvironment.ts:14-21,60-140` 与 `debug.ts:30-68,91-111,229-249` 已经分别把：
