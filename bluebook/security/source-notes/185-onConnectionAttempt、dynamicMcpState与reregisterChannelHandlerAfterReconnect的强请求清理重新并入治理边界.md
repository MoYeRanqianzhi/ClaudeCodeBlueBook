...
| control-plane reintegration | `src/cli/print.ts:3146-3204,3255-3445` | 为什么 print mode 里 recovery 之后还要单独写回 state 与重绑 handlers |
