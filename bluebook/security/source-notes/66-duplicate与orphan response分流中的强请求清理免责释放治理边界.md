...
## 9. 为什么这层不等于 `65` 的 forgetting gate
...
1. `65` 的典型形态是 retained IDs、bounded eviction、anti-duplicate memory
2. `66` 的典型形态是 duplicate ignore、orphan compensate-or-refuse、transcript-resolved amnesty、stale prompt teardown
