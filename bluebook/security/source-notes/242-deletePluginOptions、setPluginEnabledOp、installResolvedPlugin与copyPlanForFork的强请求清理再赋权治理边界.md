...
| explicit enable entitlement | `src/services/plugins/pluginOperations.ts:560-727` | 为什么对象回来不等于自动恢复 enabled entitlement |
...
它在 `pluginOperations.ts:560-727` 明确把 enable / disable 写成独立动作：
