...
`security/` 当前有 274 篇正文，范围 `00-273`；`appendix/` 当前有 257 篇速查文档；`source-notes/` 当前有 124 篇源码剖面。
...
- `147-273` 这一整段已经证明：弱层只能说明局部事实，强层才有权宣布更高阶治理结果；任何弱层都不能越级冒充强层。
...
- 想直看治理链主干：先读 `147-273 -> appendix/131-257 -> source-notes/01-124`。
