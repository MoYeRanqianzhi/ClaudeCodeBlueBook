...
`security/` 当前有 249 篇正文，范围 `00-248`；`appendix/` 当前有 232 篇速查文档；`source-notes/` 当前有 99 篇源码剖面。
...
- 想直看治理链主干：先读 `147-248 -> appendix/131-232 -> source-notes/01-99`。
