...
`security/` 当前有 387 篇正文，范围 `00-386`；`appendix/` 当前有 370 篇速查文档；`source-notes/` 当前有 237 篇源码剖面。
...
- `147-386` 这一整段已经证明：弱层只能说明局部事实，强层才有权宣布更高阶治理结果；任何弱层都不能越级冒充强层。
...
- 想直看治理链主干：先读 `147-386 -> appendix/131-370 -> source-notes/01-237`。
