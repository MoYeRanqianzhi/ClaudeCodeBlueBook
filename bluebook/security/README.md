...
`security/` 当前有 253 篇正文，范围 `00-252`；`appendix/` 当前有 236 篇速查文档；`source-notes/` 当前有 103 篇源码剖面。
...
- 想直看治理链主干：先读 `147-252 -> appendix/131-236 -> source-notes/01-103`。
