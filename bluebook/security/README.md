...
`security/` 当前有 378 篇正文，范围 `00-377`；`appendix/` 当前有 361 篇速查文档；`source-notes/` 当前有 228 篇源码剖面。
...
- `147-377` 这一整段已经证明：弱层只能说明局部事实，强层才有权宣布更高阶治理结果；任何弱层都不能越级冒充强层。
...
- 想直看治理链主干：先读 `147-377 -> appendix/131-361 -> source-notes/01-228`。
