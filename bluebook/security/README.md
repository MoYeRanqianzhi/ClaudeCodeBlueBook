...
`security/` 当前有 250 篇正文，范围 `00-249`；`appendix/` 当前有 233 篇速查文档；`source-notes/` 当前有 100 篇源码剖面。
...
- 想直看治理链主干：先读 `147-249 -> appendix/131-233 -> source-notes/01-100`。
