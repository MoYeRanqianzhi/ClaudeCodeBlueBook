...
`security/` 当前有 311 篇正文，范围 `00-310`；`appendix/` 当前有 294 篇速查文档；`source-notes/` 当前有 161 篇源码剖面。
...
- `147-310` 这一整段已经证明：弱层只能说明局部事实，强层才有权宣布更高阶治理结果；任何弱层都不能越级冒充强层。
...
- 想直看治理链主干：先读 `147-310 -> appendix/131-294 -> source-notes/01-161`。
