...
`security/` 当前有 252 篇正文，范围 `00-251`；`appendix/` 当前有 235 篇速查文档；`source-notes/` 当前有 102 篇源码剖面。
...
- 想直看治理链主干：先读 `147-251 -> appendix/131-235 -> source-notes/01-102`。
