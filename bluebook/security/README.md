...
`security/` 当前有 251 篇正文，范围 `00-250`；`appendix/` 当前有 234 篇速查文档；`source-notes/` 当前有 101 篇源码剖面。
...
- 想直看治理链主干：先读 `147-250 -> appendix/131-234 -> source-notes/01-101`。
