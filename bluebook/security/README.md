...
`security/` 当前有 254 篇正文，范围 `00-253`；`appendix/` 当前有 237 篇速查文档；`source-notes/` 当前有 104 篇源码剖面。
...
- 想直看治理链主干：先读 `147-253 -> appendix/131-237 -> source-notes/01-104`。
