...
这一页服务于 [430-安全载体家族强请求清理重新并入治理与强请求清理重新投影治理分层](../430-安全载体家族强请求清理重新并入治理与强请求清理重新投影治理分层.md)。
...
`旧 stronger-request truth 既然已经并回当前世界，所以所有 surface 自然就会正确表达它`
