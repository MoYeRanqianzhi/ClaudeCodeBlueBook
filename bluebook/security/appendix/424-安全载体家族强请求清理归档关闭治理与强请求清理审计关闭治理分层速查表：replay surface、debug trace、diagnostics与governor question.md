...
这一页服务于 [440-安全载体家族强请求清理归档关闭治理与强请求清理审计关闭治理分层](../440-安全载体家族强请求清理归档关闭治理与强请求清理审计关闭治理分层.md)。
...
| “有 replay 开关只是兼容问题，不影响安全边界” | replay is an evidentiary surface here |
