...
- `390`
  载体家族强请求清理遗忘治理与强请求清理免责释放治理分层。
  入口：[390-安全载体家族强请求清理遗忘治理与强请求清理免责释放治理分层速查表：forgetting gate、liability-release gate、compensate-or-refuse与governor question](390-安全载体家族强请求清理遗忘治理与强请求清理免责释放治理分层速查表：forgetting gate、liability-release gate、compensate-or-refuse与governor question.md)。
- `391`
  载体家族强请求清理免责释放治理与强请求清理归档关闭治理分层。
  入口：[391-安全载体家族强请求清理免责释放治理与强请求清理归档关闭治理分层速查表：active lifecycle、waiting surface、queue admission与governor question](391-安全载体家族强请求清理免责释放治理与强请求清理归档关闭治理分层速查表：active lifecycle、waiting surface、queue admission与governor question.md)。
- `392`
  载体家族强请求清理归档关闭治理与强请求清理审计关闭治理分层。
  入口：[392-安全载体家族强请求清理归档关闭治理与强请求清理审计关闭治理分层速查表：replay surface、debug trace、diagnostics与governor question](392-安全载体家族强请求清理归档关闭治理与强请求清理审计关闭治理分层速查表：replay surface、debug trace、diagnostics与governor question.md)。
- `393`
  载体家族强请求清理审计关闭治理与强请求清理不可逆擦除治理分层。
  入口：[393-安全载体家族强请求清理审计关闭治理与强请求清理不可逆擦除治理分层速查表：audit-close surface、irreversible-erasure surface、carrier destruction与governor question](393-安全载体家族强请求清理审计关闭治理与强请求清理不可逆擦除治理分层速查表：audit-close surface、irreversible-erasure surface、carrier destruction与governor question.md)。
- `394`
  载体家族强请求清理不可逆擦除治理与强请求清理保留期治理分层。
  入口：[394-安全载体家族强请求清理不可逆擦除治理与强请求清理保留期治理分层速查表：time law、validation veto、admission gate与coverage gap](394-安全载体家族强请求清理不可逆擦除治理与强请求清理保留期治理分层速查表：time law、validation veto、admission gate与coverage gap.md)。
- `395`
  载体家族强请求清理保留期治理与强请求清理保留期执行诚实性治理分层。
  入口：[395-安全载体家族强请求清理保留期治理与强请求清理保留期执行诚实性治理分层速查表：surface、declared scope、runtime truth与honesty gap](395-安全载体家族强请求清理保留期治理与强请求清理保留期执行诚实性治理分层速查表：surface、declared scope、runtime truth与honesty gap.md)。
- `396`
  载体家族强请求清理保留期执行诚实性治理与强请求清理隔离治理分层。
  入口：[396-安全载体家族强请求清理保留期执行诚实性治理与强请求清理隔离治理分层速查表：surface、honesty answer、isolation question、positive control与gap](396-安全载体家族强请求清理保留期执行诚实性治理与强请求清理隔离治理分层速查表：surface、honesty answer、isolation question、positive control与gap.md)。
- `397`
  载体家族强请求清理隔离治理与强请求清理家族宪法治理分层。
  入口：[397-安全载体家族强请求清理隔离治理与强请求清理家族宪法治理分层速查表：carrier family、constitution world、cleanup root、current gate与governor question](397-安全载体家族强请求清理隔离治理与强请求清理家族宪法治理分层速查表：carrier family、constitution world、cleanup root、current gate与governor question.md)。
- `398`
  载体家族强请求清理家族宪法治理与强请求清理制度理由治理分层。
  入口：[398-安全载体家族强请求清理家族宪法治理与强请求清理制度理由治理分层速查表：carrier family、primary risk object、operational duty、host visibility与rationale drift](398-安全载体家族强请求清理家族宪法治理与强请求清理制度理由治理分层速查表：carrier family、primary risk object、operational duty、host visibility与rationale drift.md)。
- `399`
  载体家族强请求清理制度理由治理与强请求清理元数据治理分层。
  入口：[399-安全载体家族强请求清理制度理由治理与强请求清理元数据治理分层速查表：carrier family、naming surface、path helper、projection surface与gap](399-安全载体家族强请求清理制度理由治理与强请求清理元数据治理分层速查表：carrier family、naming surface、path helper、projection surface与gap.md)。
- `400`
  载体家族强请求清理制度元数据治理与强请求清理运行时符合性治理分层。
  入口：[400-安全载体家族强请求清理制度元数据治理与强请求清理运行时符合性治理分层速查表：metadata signal、runtime truth、gap type、receipt surface与governor question](400-安全载体家族强请求清理制度元数据治理与强请求清理运行时符合性治理分层速查表：metadata signal、runtime truth、gap type、receipt surface与governor question.md)。
- `401`
  载体家族强请求清理运行时符合性治理与强请求清理反漂移验证治理分层。
  入口：[401-安全载体家族强请求清理运行时符合性治理与强请求清理反漂移验证治理分层速查表：positive control、verifier pattern、cleanup current gap、drift risk与governor question](401-安全载体家族强请求清理运行时符合性治理与强请求清理反漂移验证治理分层速查表：positive control、verifier pattern、cleanup current gap、drift risk与governor question.md)。
- `402`
  载体家族强请求清理反漂移验证治理与强请求清理修复治理分层。
  入口：[402-安全载体家族强请求清理反漂移验证治理与强请求清理修复治理分层速查表：verifier surface、governance consequence、repair scope、cleanup current gap与governor question](402-安全载体家族强请求清理反漂移验证治理与强请求清理修复治理分层速查表：verifier surface、governance consequence、repair scope、cleanup current gap与governor question.md)。
- `403`
  载体家族强请求清理修复治理与强请求清理迁移治理分层。
...
- `412`
  载体家族强请求清理连续性治理与强请求清理恢复治理分层。
  入口：[412-安全载体家族强请求清理连续性治理与强请求清理恢复治理分层速查表：fresh proof、reconnect verdict、consumer discipline与governor question](412-安全载体家族强请求清理连续性治理与强请求清理恢复治理分层速查表：fresh proof、reconnect verdict、consumer discipline与governor question.md)。
- `413`
  载体家族强请求清理恢复治理与强请求清理重新并入治理分层。
...
- `419`
  载体家族强请求清理续打治理与强请求清理完成治理分层。
  入口：[419-安全载体家族强请求清理续打治理与强请求清理完成治理分层速查表：continuation decision、completion decision、result settlement与governor question](419-安全载体家族强请求清理续打治理与强请求清理完成治理分层速查表：continuation decision、completion decision、result settlement与governor question.md)。
- `420`
  载体家族强请求清理完成治理与强请求清理终局治理分层。
  入口：[420-安全载体家族强请求清理完成治理与强请求清理终局治理分层速查表：completion scope、finality scope、readback evidence与governor question](420-安全载体家族强请求清理完成治理与强请求清理终局治理分层速查表：completion scope、finality scope、readback evidence与governor question.md)。
- `421`
  载体家族强请求清理终局治理与强请求清理遗忘治理分层。
  入口：[421-安全载体家族强请求清理终局治理与强请求清理遗忘治理分层速查表：finality scope、forgetting gate、retained memory与governor question](421-安全载体家族强请求清理终局治理与强请求清理遗忘治理分层速查表：finality scope、forgetting gate、retained memory与governor question.md)。
- `422`
  载体家族强请求清理遗忘治理与强请求清理免责释放治理分层。
  入口：[422-安全载体家族强请求清理遗忘治理与强请求清理免责释放治理分层速查表：forgetting gate、liability-release gate、compensate-or-refuse与governor question](422-安全载体家族强请求清理遗忘治理与强请求清理免责释放治理分层速查表：forgetting gate、liability-release gate、compensate-or-refuse与governor question.md)。
- `423`
  载体家族强请求清理免责释放治理与强请求清理归档关闭治理分层。
  入口：[423-安全载体家族强请求清理免责释放治理与强请求清理归档关闭治理分层速查表：active lifecycle、waiting surface、queue admission与governor question](423-安全载体家族强请求清理免责释放治理与强请求清理归档关闭治理分层速查表：active lifecycle、waiting surface、queue admission与governor question.md)。
- `424`
  载体家族强请求清理归档关闭治理与强请求清理审计关闭治理分层。
  入口：[424-安全载体家族强请求清理归档关闭治理与强请求清理审计关闭治理分层速查表：replay surface、debug trace、diagnostics与governor question](424-安全载体家族强请求清理归档关闭治理与强请求清理审计关闭治理分层速查表：replay surface、debug trace、diagnostics与governor question.md)。
- `425`
  载体家族强请求清理审计关闭治理与强请求清理不可逆擦除治理分层。
...
- `433`
  载体家族强请求清理运行时符合性治理与强请求清理反漂移验证治理分层。
  入口：[433-安全载体家族强请求清理运行时符合性治理与强请求清理反漂移验证治理分层速查表：positive control、verifier pattern、cleanup current gap、drift risk与governor question](433-安全载体家族强请求清理运行时符合性治理与强请求清理反漂移验证治理分层速查表：positive control、verifier pattern、cleanup current gap、drift risk与governor question.md)。
- `434`
  载体家族强请求清理反漂移验证治理与强请求清理修复治理分层。
...
- `446`
  载体家族强请求清理重新并入治理与强请求清理重新投影治理分层。
  入口：[446-安全载体家族强请求清理重新并入治理与强请求清理重新投影治理分层速查表：status grammar、notification policy、control payload与governor question](446-安全载体家族强请求清理重新并入治理与强请求清理重新投影治理分层速查表：status grammar、notification policy、control payload与governor question.md)。
- `447`
  载体家族强请求清理重新投影治理与强请求清理重新担保治理分层。
...
- `454`
  载体家族强请求清理遗忘治理与强请求清理免责释放治理分层。
  入口：[454-安全载体家族强请求清理遗忘治理与强请求清理免责释放治理分层速查表：forgetting gate、liability-release gate、compensate-or-refuse与governor question](454-安全载体家族强请求清理遗忘治理与强请求清理免责释放治理分层速查表：forgetting gate、liability-release gate、compensate-or-refuse与governor question.md)。

## 怎么配合主线读

- 读 [../README.md](../README.md) 时，把附录当速查卡，不当主阅读路径。
- 想快速核对“字段从哪来、谁能签字、哪条路径被禁止、当前该看哪张卡”，优先来附录。
- 想快速进入当前这段强请求清理子链，优先看 `450-454` 这一段。
