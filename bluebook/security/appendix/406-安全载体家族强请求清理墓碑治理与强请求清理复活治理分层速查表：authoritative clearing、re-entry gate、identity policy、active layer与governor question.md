...
这一页服务于 [422-安全载体家族强请求清理墓碑治理与强请求清理复活治理分层](../422-安全载体家族强请求清理墓碑治理与强请求清理复活治理分层.md)。
...
`旧 stronger-request cleanup 对象有墓碑，所以回来规则也已经清楚`
