...
这一页服务于 [454-安全载体家族强请求清理墓碑治理与强请求清理复活治理分层](../454-安全载体家族强请求清理墓碑治理与强请求清理复活治理分层.md)。
...
| tombstone deletion path | none; deletion helper only removes old object | no re-entry gate present | no identity return semantics | stronger-request cleanup likewise lacks a dedicated resurrection plane today | who keeps deletion semantics from being mistaken for comeback semantics | `sessionStorage.ts:925-945,1470-1473` |
