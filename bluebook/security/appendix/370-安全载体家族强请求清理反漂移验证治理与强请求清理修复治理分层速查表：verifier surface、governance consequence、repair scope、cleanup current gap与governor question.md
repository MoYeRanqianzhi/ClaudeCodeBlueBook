...
这一页服务于 [386-安全载体家族强请求清理反漂移验证治理与强请求清理修复治理分层](../386-安全载体家族强请求清理反漂移验证治理与强请求清理修复治理分层.md)。
...
| stronger-request cleanup receipt gap | currently no explicit repair governor | could mean promoting `CleanupResult`, adding receipt surface, or lowering claims | unresolved | who decides whether to add surfaced receipt or reduce conformance language | `cleanup.ts:33-44,575-598` |
