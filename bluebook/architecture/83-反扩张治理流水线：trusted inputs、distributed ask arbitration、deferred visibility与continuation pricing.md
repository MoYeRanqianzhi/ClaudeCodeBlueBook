...
| `durable-transient cleanup` | rewind / stale field cleanup / authority requalification | rewind action + cleared state fields + post-resume readback | 把 rollback object 当治理根对象 |
