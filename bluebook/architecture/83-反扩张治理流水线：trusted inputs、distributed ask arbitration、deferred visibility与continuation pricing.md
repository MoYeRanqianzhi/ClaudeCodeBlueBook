...
| `externalized truth chain` | state writeback + metadata readback | `permission_mode / session_state_changed / worker_status / pending_action / get_context_usage` | 只看 permission 投影名字、token 条或单条状态文案 |
