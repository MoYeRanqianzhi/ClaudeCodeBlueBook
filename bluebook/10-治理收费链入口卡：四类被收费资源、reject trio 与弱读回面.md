...
下面这些对象都只配做 projection / readback / consumer，不配代签治理真相：
...
- 缺 signer / ledger / cleanup 机制入口，回 [security/README.md](security/README.md)
- 缺用户侧读回、恢复资格与 reopen 顺序，回 [risk/README.md](risk/README.md)
