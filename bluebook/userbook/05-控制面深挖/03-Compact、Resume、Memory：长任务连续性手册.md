...
- `Compact / Resume / Memory / Export` 都只是 `decision window -> continuation pricing -> durable-transient cleanup` 的 continuation consumer，不是独立控制面。
...
## 这些命令都是 continuation consumer，不是新宪法
