...
`/copy`、`/rename`、`/export`、`/branch`、`/rewind`、`/clear` 不在回答长任务怎样续上，而是在回答当前工作对象怎样被复制、命名、导出、分叉、回退和清空。
...
- `Resume` 让你回来继续。
- `Memory` 让长期约束留下来。
- 会话运营层让当前工作对象被复制、命名、导出、分叉、回退和清空。

如果你主要卡在当前工作对象怎样被复制、命名、导出、分叉、回退和清空，应转去读：

- [07-会话运营、分叉与回退专题.md](../04-%E4%B8%93%E9%A2%98%E6%B7%B1%E6%BD%9C/07-%E4%BC%9A%E8%AF%9D%E8%BF%90%E8%90%A5%E3%80%81%E5%88%86%E5%8F%89%E4%B8%8E%E5%9B%9E%E9%80%80%E4%B8%93%E9%A2%98.md)
