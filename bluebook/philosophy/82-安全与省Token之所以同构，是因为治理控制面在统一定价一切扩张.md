...
更硬一点说，治理前门真正先裁的不是动作，而是：

- `visible world`

如果模型先看见了过宽的工具、schema 与上下文，风险与 token 就已经在动作发生前一起被烧掉了。
...
所以更准确的说法不是“系统多了一层 classifier”，而是：
...
因为它真正减少的不是字数，而是免费继续、免费暴露与免费重试；被省下来的 token，本来就是未获批准的扩张时间。

### 10.6 为什么成熟治理要先裁 visible world，再谈动作许可

因为动作还没发生前，可见世界就已经在决定风险边界与 token 去向；若这一步失守，后面的审批只是在为已经发生的扩张补票。

### 10.7 为什么 classifier 也必须进入统一定价链

因为若系统默认“多跑一次检查总没坏处”，治理控制面就会把自己的保护动作变成新的免费扩张源。
