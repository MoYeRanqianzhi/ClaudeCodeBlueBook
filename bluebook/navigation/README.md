...
`navigation/` 当前有 103 篇编号文档，范围 `01-103`。本目录是跨目录路由层：把主线章节、专题目录、反例、演练、协议工件和 builder 手册压回稳定的阅读地图与反查入口。
...
- `81-103`: 改写纠偏、精修、repair card、共同 reject 与 reopen 责任导航。
...
- 当前深层协议链已推进到 `98-103`，下一步前向入口是 `104 -> ../casebooks/70-72`。
