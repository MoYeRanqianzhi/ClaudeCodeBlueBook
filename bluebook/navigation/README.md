...
`navigation/` 当前有 104 篇编号文档，范围 `01-104`。本目录是跨目录路由层：把主线章节、专题目录、反例、演练、协议工件和 builder 手册压回稳定的阅读地图与反查入口。
...
- [07-深方法导航：共享前缀、合同优先与依赖图诚实性](07-深方法导航：共享前缀、合同优先与依赖图诚实性.md)
- [15-苏格拉底审读导航：Prompt魔力、安全定价与源码先进性的自我校准](15-苏格拉底审读导航：Prompt魔力、安全定价与源码先进性的自我校准.md)
...
- 当前深层协议链已推进到 `98-104`，下一步前向入口是 `105 -> ../guides/99-101`。
