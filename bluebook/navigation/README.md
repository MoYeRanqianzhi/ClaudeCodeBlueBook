...
- [15-苏格拉底审读导航：请求装配、扩张定价与源码先进性](15-苏格拉底审读导航：Prompt魔力、安全定价与源码先进性的自我校准.md)
  失稳前的高阶审读入口。
- [41-机制哲学导航：请求装配、统一定价治理与故障模型编码如何回到第一性原理](41-机制哲学导航：Prompt魔力、统一定价治理与故障模型编码如何回到第一性原理.md)
  把深专题回压成第一性原理。
- [46-宿主迁移工单导航：请求装配、治理与故障模型支持面如何进入实施顺序、交接包与灰度发布](46-宿主迁移工单导航：Prompt、治理与故障模型支持面如何进入实施顺序、交接包与灰度发布.md)
  进入宿主实现、迁移、验收与收口链。
