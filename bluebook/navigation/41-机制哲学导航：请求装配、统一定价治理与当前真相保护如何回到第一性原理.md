...
更稳一点说，production 级 Prompt magic 不是多一层口号，而是 `same-world compiler` 让 verify、delegate、tool choice 与 feedback loop 继续共享同一个 effort-budget 闭环；这条 why 继续回 `../philosophy/84` 的 owner 定义，不在本页重造 object chain。
