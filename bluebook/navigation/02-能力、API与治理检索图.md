...
| 如果想先抓三条最高阶判断，而不是先读功能表 | `09（总图镜像）` | `philosophy/84`、`philosophy/85`、`philosophy/86`、`philosophy/87`、`guides/99-102`、`playbooks/77-79` |
...
| 如果想在公开镜像条件下稳当地判断源码质量 | `guides/102`、`philosophy/86`、`philosophy/87` | `architecture/38`、`architecture/63`、`architecture/84` |
...
- 再按题型分流到 `philosophy/84`、`philosophy/85`、`philosophy/86`、`philosophy/87`
