...
如果排查已经开始给 `shim / snapshot / pointer / authority / seam / recovery / eviction` 排 later-maintainer reject 顺序，说明你缺的已不是苏格拉底问题，而是 current-truth owner chain；统一回 `guides/102 -> philosophy/87 -> architecture/README`。
