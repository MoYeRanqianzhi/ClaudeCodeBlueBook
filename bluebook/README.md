...
`bluebook/` 分成两层：根目录 `00-08` 是主线章节，子目录负责架构、API、使用、安全、风险、样本与演练等专题展开。总索引只保留一级路由和稳定阅读路径；深层反查与交叉跳转统一下沉到各子目录 README，尤其是 `navigation/README.md`。
...
- [navigation/README.md](navigation/README.md): 99 篇，阅读地图、问题反查与机制回灌
- [architecture/README.md](architecture/README.md): 81 篇，运行时结构、状态机和控制面
- [api/README.md](api/README.md): 92 篇，命令、工具、状态、宿主与扩展协议
- [guides/README.md](guides/README.md): 95 篇，使用方法、模板、审读清单与构建手册
- [philosophy/README.md](philosophy/README.md): 83 篇，第一性原理、治理观和源码先进性解释
- [casebooks/README.md](casebooks/README.md): 66 篇，失败样本、反例与失真原型
